...
namespace Dapper.Wrappers.Builders
{
    ...
    public abstract class
        QueryBuilder<TBuilderContext, TOperations1, TOperations2, TOperations3, TOperations4, TOperations5> : QueryBuilder,
            IQueryBuilder<TBuilderContext, TOperations1, TOperations2, TOperations3, TOperations4, TOperations5>
    {
        /// <summary>
            ...
            TOperations5 operationObject5)
        {
            ...
            AddQueryToContext(context, operations1, operations2, operations3, operations4, operations5);
        }
